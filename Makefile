...
jupyter-conf:
	sudo -H pip3 install jupyter jupyterlab ipykernel pandas cobra escher seaborn bokeh nbopen dnaplotlib pysb testresources twine rise
	sudo -H pip2 install jupyter jupyterlab ipykernel pandas cobra escher seaborn bokeh nbopen dnaplotlib pysb testresources twine rise
